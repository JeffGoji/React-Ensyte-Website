                ...
                <div className="col-sm-12 col-md-12 col-lg-10">
                    <div className="card mt-5 mb-5 cardshadow">
                        ...
                        <div className="fs-6 p-2">
                            <h3 className="blue-text text-center mt-5">Customer Relationship Management & Contracts Management</h3>
                            ...
                            <h3 className="blue-text text-center mt-5">Pipelines & Points</h3>
                            ...
                            <h3 className="blue-text text-center mt-5">Electronic Bulletin Board (Web Portal)</h3>
                            ...
                            <h3 className="blue-text text-center mt-5">Capacity Release Management</h3>
