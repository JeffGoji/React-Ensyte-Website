    ...
    return (
        <div className="container-fluid bg-white">
            <div className="row mt-5 blue-bg">
                <h1 className="text-center mt-5 text-white">Marketing for Natural Gas Producers</h1>
            </div>
                ...
                <div className="col-sm-12 col-md-12 col-lg-10">
                    <div className="card mt-3 mb-3 cardshadow">
                        ...
                        <div className="fs-6 p-2">
                            <h3 className="blue-text text-center mt-4">Producer Gas Supply Module</h3>
                            ...
                            <h3 className="blue-text text-center mt-4">Producer Gas Sales and Transportation Modules</h3>
                            ...
                            <h3 className="blue-text text-center mt-4">Netback Settlement to Working Interest Owners</h3>
                            ...
                            <h3 className="blue-text text-center mt-4">Electronic Bulletin Board (EBB)</h3>
