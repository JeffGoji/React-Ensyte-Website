            ...
            <div className="col h-100" >
                <div className="card mb-5 h-100">
                    ...
                    <div className="card-body">
                        <img src={img22} alt='data Article' className='rounded img-fluid imgShadow mb-4' style={{ maxHeight: "14rem" }} />
                        <h4 className="card-title">ENSYTE Wins Producer Services Client</h4>
                    </div>
                ...
                <div className="modal-dialog modal-xl">
                    ...
                    <div className="modal-content text-center">
                        <div className="modal-header text-center blue-bg">
                            <h3 className="modal-title text-white center" id="staticBackdropLabel">ENSYTE Wins Producer Services Client</h3>
                            <button type="button" className="btn-close text-white" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div className="modal-body fs-6 text-wrap">
                            <div className="text-center mb-4">
                                <img src={img22} alt="Services Solutions" className='imgShadow img-fluid rounded' />
                            </div>
                            <div className="card border-0 mt-5 ">
                                <h2 className="text-center">ENSYTE Wins Producer Services Client</h2>
                                <div className="card-body">
                                    <div className="row">
