            ...
            <div className="col h-100" >
                <div className="card mb-5 h-100">
                    ...
                    <div className="card-body">
                        <img src={img20} alt='data Article' className='rounded img-fluid imgShadow mb-2' style={{ maxHeight: "15rem" }} />
                        <h3 className="card-title">Why is GASTAR™ the Preferred Solution?</h3>
