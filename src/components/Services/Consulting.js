    ...
    return (
        <main className='container-fluid'>
            ...
            <div className='row bg-white text-center mt-5'>
                ...
                <div className='col-lg-8 col-md-12 col-sm-12 text-start p-2'>
                    <h2 className='text-center'>Consulting for Custom Solutions</h2>
                    <p>Companies that elect to build customized systems internally or revise legacy systems utilize ENSYTE specialists to guide work teams during the design and implementation. Providing pre-implementation scoping, developing a detailed project plan, and coordinating the achievement of deliverables all make a significant impact in the assurance of a successful project completion. In addition, ENSYTE now offers enhancement to clients who prefer to utilize their own in-house systems to bring the desired legacy products onto Microsoft’s latest technology platform.</p>
                </div>
            </div>
        </main>
    )
